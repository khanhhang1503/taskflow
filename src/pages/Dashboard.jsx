...
export default function Dashboard() {
  const stats = [
    { label: "Total Projects", count: "3" },
    { label: "Total Tasks", count: "3" },
    { label: "On Going Tasks", count: "3" },
    { label: "Completed Tasks", count: "1" },
  ];

  const dailyTasks = [
    { time: "09 AM", title: "Finalize UI Colors", status: "purple" },
    { time: "10 AM", title: "Change UI Colors", status: "gray" },
    { time: "11 AM", title: "Submit UI Colors Report", status: "purple" },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-8 pt-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <button className="flex items-center gap-2 bg-[#4C75F2] hover:bg-blue-700 text-white font-medium px-5 py-2.5 rounded-xl shadow-lg shadow-blue-500/20 text-sm transition-all ml-4">
        ...
        {/* --- HÀNG 1: Daily Tasks + Calendar --- */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          {/* Daily Tasks Card (2 cột) */}
          ...
          {/* Mini Calendar Widget (1 cột) */}
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-center justify-between mb-3">
              <button className="text-gray-400 hover:text-gray-600">‹</button>
              <h3 className="font-bold text-gray-800 text-sm">March / 2025</h3>
              <button className="text-gray-400 hover:text-gray-600">›</button>
            </div>
        ...
        {/* --- HÀNG 2: Tasks List + Projects --- */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          {/* Tasks List Card (2 cột) */}
          <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-bold text-gray-900 text-base">Tasks</h2>
              </div>
            ...
            <div className="space-y-4 my-auto">
              {taskList.map((task) => (
                <div
                  key={task.id}
                  className="grid grid-cols-[1fr_90px_80px_90px_32px] items-center gap-4 pb-4 border-b border-gray-100 last:border-0 last:pb-0"
                >
          ...
          {/* Projects Widget (1 cột) - Đã đưa vào đúng hàng Grid 2 */}
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <div className="p-1.5 border border-gray-200 rounded-lg">
                ...
                <h2 className="font-bold text-gray-900 text-base">Projects</h2>
              </div>
              <div className="flex items-center gap-2">
                <button className="p-1 text-gray-400 hover:text-gray-600">
                  <SlidersHorizontal className="w-3.5 h-3.5" />
